...
"production" !== ("TURBOPACK compile-time value", "development") && function() {
    ...
    function updateSuspenseComponent(current, workInProgress, renderLanes) {
        ...
        (JSCompiler_object_inline_digest_2471 = didSuspend) || (JSCompiler_object_inline_digest_2471 = null !== current && null === current.memoizedState ? !1 : 0 !== (suspenseStackCursor.current & ForceSuspenseFallback));
        JSCompiler_object_inline_digest_2471 && (JSCompiler_object_inline_componentStack_2473 = !0, workInProgress.flags &= -129);
        JSCompiler_object_inline_digest_2471 = 0 !== (workInProgress.flags & 32);
        workInProgress.flags &= -33;
        if (null === current) {
            if (isHydrating) {
                JSCompiler_object_inline_componentStack_2473 ? pushPrimaryTreeSuspenseHandler(workInProgress) : reuseSuspenseHandlerOnStack(workInProgress);
                if (isHydrating) {
                    ...
                    JSCompiler_temp && (warnNonHydratedInstance(workInProgress, JSCompiler_object_inline_message_2470), throwOnHydrationMismatch(workInProgress));
                }
                JSCompiler_object_inline_message_2470 = workInProgress.memoizedState;
                if (null !== JSCompiler_object_inline_message_2470 && (JSCompiler_object_inline_message_2470 = JSCompiler_object_inline_message_2470.dehydrated, null !== JSCompiler_object_inline_message_2470)) return isSuspenseInstanceFallback(JSCompiler_object_inline_message_2470) ? workInProgress.lanes = 32 : workInProgress.lanes = 536870912, null;
                popSuspenseHandler(workInProgress);
            }
            JSCompiler_object_inline_message_2470 = JSCompiler_object_inline_stack_2472.children;
            JSCompiler_object_inline_stack_2472 = JSCompiler_object_inline_stack_2472.fallback;
            if (JSCompiler_object_inline_componentStack_2473) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_componentStack_2473 = workInProgress.mode, JSCompiler_object_inline_message_2470 = mountWorkInProgressOffscreenFiber({
                mode: "hidden",
                children: JSCompiler_object_inline_message_2470
            }, JSCompiler_object_inline_componentStack_2473), JSCompiler_object_inline_stack_2472 = createFiberFromFragment(JSCompiler_object_inline_stack_2472, JSCompiler_object_inline_componentStack_2473, renderLanes, null), JSCompiler_object_inline_message_2470.return = workInProgress, JSCompiler_object_inline_stack_2472.return = workInProgress, JSCompiler_object_inline_message_2470.sibling = JSCompiler_object_inline_stack_2472, workInProgress.child = JSCompiler_object_inline_message_2470, JSCompiler_object_inline_componentStack_2473 = workInProgress.child, JSCompiler_object_inline_componentStack_2473.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_componentStack_2473.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_digest_2471, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2472;
            pushPrimaryTreeSuspenseHandler(workInProgress);
            return mountSuspensePrimaryChildren(workInProgress, JSCompiler_object_inline_message_2470);
        }
        var prevState = current.memoizedState;
        if (null !== prevState && (JSCompiler_object_inline_message_2470 = prevState.dehydrated, null !== JSCompiler_object_inline_message_2470)) {
            if (didSuspend) workInProgress.flags & 256 ? (pushPrimaryTreeSuspenseHandler(workInProgress), workInProgress.flags &= -257, workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes)) : null !== workInProgress.memoizedState ? (reuseSuspenseHandlerOnStack(workInProgress), workInProgress.child = current.child, workInProgress.flags |= 128, workInProgress = null) : (reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_componentStack_2473 = JSCompiler_object_inline_stack_2472.fallback, JSCompiler_object_inline_message_2470 = workInProgress.mode, JSCompiler_object_inline_stack_2472 = mountWorkInProgressOffscreenFiber({
                mode: "visible",
                children: JSCompiler_object_inline_stack_2472.children
            }, JSCompiler_object_inline_message_2470), JSCompiler_object_inline_componentStack_2473 = createFiberFromFragment(JSCompiler_object_inline_componentStack_2473, JSCompiler_object_inline_message_2470, renderLanes, null), JSCompiler_object_inline_componentStack_2473.flags |= 2, JSCompiler_object_inline_stack_2472.return = workInProgress, JSCompiler_object_inline_componentStack_2473.return = workInProgress, JSCompiler_object_inline_stack_2472.sibling = JSCompiler_object_inline_componentStack_2473, workInProgress.child = JSCompiler_object_inline_stack_2472, reconcileChildFibers(workInProgress, current.child, null, renderLanes), JSCompiler_object_inline_stack_2472 = workInProgress.child, JSCompiler_object_inline_stack_2472.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_stack_2472.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_digest_2471, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, workInProgress = JSCompiler_object_inline_componentStack_2473);
            else if (pushPrimaryTreeSuspenseHandler(workInProgress), isHydrating && console.error("We should not be hydrating here. This is a bug in React. Please file a bug."), isSuspenseInstanceFallback(JSCompiler_object_inline_message_2470)) {
                JSCompiler_object_inline_digest_2471 = JSCompiler_object_inline_message_2470.nextSibling && JSCompiler_object_inline_message_2470.nextSibling.dataset;
                ...
                JSCompiler_temp = JSCompiler_object_inline_componentStack_2473 = componentStack;
                JSCompiler_object_inline_componentStack_2473 = JSCompiler_object_inline_message_2470 ? Error(JSCompiler_object_inline_message_2470) : Error("The server could not finish this Suspense boundary, likely due to an error during server rendering. Switched to client rendering.");
                JSCompiler_object_inline_componentStack_2473.stack = JSCompiler_object_inline_stack_2472 || "";
                JSCompiler_object_inline_componentStack_2473.digest = JSCompiler_object_inline_digest_2471;
                JSCompiler_object_inline_digest_2471 = void 0 === JSCompiler_temp ? null : JSCompiler_temp;
                ...
                "string" === typeof JSCompiler_object_inline_digest_2471 && CapturedStacks.set(JSCompiler_object_inline_componentStack_2473, JSCompiler_object_inline_stack_2472);
                queueHydrationError(JSCompiler_object_inline_stack_2472);
                workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
            } else if (didReceiveUpdate || propagateParentContextChanges(current, workInProgress, renderLanes, !1), JSCompiler_object_inline_digest_2471 = 0 !== (renderLanes & current.childLanes), didReceiveUpdate || JSCompiler_object_inline_digest_2471) {
                JSCompiler_object_inline_digest_2471 = workInProgressRoot;
                if (null !== JSCompiler_object_inline_digest_2471 && (JSCompiler_object_inline_stack_2472 = renderLanes & -renderLanes, JSCompiler_object_inline_stack_2472 = 0 !== (JSCompiler_object_inline_stack_2472 & 42) ? 1 : getBumpedLaneForHydrationByLane(JSCompiler_object_inline_stack_2472), JSCompiler_object_inline_stack_2472 = 0 !== (JSCompiler_object_inline_stack_2472 & (JSCompiler_object_inline_digest_2471.suspendedLanes | renderLanes)) ? 0 : JSCompiler_object_inline_stack_2472, 0 !== JSCompiler_object_inline_stack_2472 && JSCompiler_object_inline_stack_2472 !== prevState.retryLane)) throw prevState.retryLane = JSCompiler_object_inline_stack_2472, enqueueConcurrentRenderForLane(current, JSCompiler_object_inline_stack_2472), scheduleUpdateOnFiber(JSCompiler_object_inline_digest_2471, current, JSCompiler_object_inline_stack_2472), SelectiveHydrationException;
                JSCompiler_object_inline_message_2470.data === SUSPENSE_PENDING_START_DATA || renderDidSuspendDelayIfPossible();
                workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
            } else JSCompiler_object_inline_message_2470.data === SUSPENSE_PENDING_START_DATA ? (workInProgress.flags |= 192, workInProgress.child = current.child, workInProgress = null) : (current = prevState.treeContext, nextHydratableInstance = getNextHydratable(JSCompiler_object_inline_message_2470.nextSibling), hydrationParentFiber = workInProgress, isHydrating = !0, hydrationErrors = null, didSuspendOrErrorDEV = !1, hydrationDiffRootDEV = null, rootOrSingletonContext = !1, null !== current && (warnIfNotHydrating(), idStack[idStackIndex++] = treeContextId, idStack[idStackIndex++] = treeContextOverflow, idStack[idStackIndex++] = treeContextProvider, treeContextId = current.id, treeContextOverflow = current.overflow, treeContextProvider = workInProgress), workInProgress = mountSuspensePrimaryChildren(workInProgress, JSCompiler_object_inline_stack_2472.children), workInProgress.flags |= 4096);
            return workInProgress;
        }
        if (JSCompiler_object_inline_componentStack_2473) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_componentStack_2473 = JSCompiler_object_inline_stack_2472.fallback, JSCompiler_object_inline_message_2470 = workInProgress.mode, JSCompiler_temp = current.child, instance = JSCompiler_temp.sibling, JSCompiler_object_inline_stack_2472 = createWorkInProgress(JSCompiler_temp, {
            mode: "hidden",
            children: JSCompiler_object_inline_stack_2472.children
        }), JSCompiler_object_inline_stack_2472.subtreeFlags = JSCompiler_temp.subtreeFlags & 65011712, null !== instance ? JSCompiler_object_inline_componentStack_2473 = createWorkInProgress(instance, JSCompiler_object_inline_componentStack_2473) : (JSCompiler_object_inline_componentStack_2473 = createFiberFromFragment(JSCompiler_object_inline_componentStack_2473, JSCompiler_object_inline_message_2470, renderLanes, null), JSCompiler_object_inline_componentStack_2473.flags |= 2), JSCompiler_object_inline_componentStack_2473.return = workInProgress, JSCompiler_object_inline_stack_2472.return = workInProgress, JSCompiler_object_inline_stack_2472.sibling = JSCompiler_object_inline_componentStack_2473, workInProgress.child = JSCompiler_object_inline_stack_2472, JSCompiler_object_inline_stack_2472 = JSCompiler_object_inline_componentStack_2473, JSCompiler_object_inline_componentStack_2473 = workInProgress.child, JSCompiler_object_inline_message_2470 = current.child.memoizedState, null === JSCompiler_object_inline_message_2470 ? JSCompiler_object_inline_message_2470 = mountSuspenseOffscreenState(renderLanes) : (JSCompiler_temp = JSCompiler_object_inline_message_2470.cachePool, null !== JSCompiler_temp ? (instance = CacheContext._currentValue, JSCompiler_temp = JSCompiler_temp.parent !== instance ? {
            parent: instance,
            pool: instance
        } : JSCompiler_temp) : JSCompiler_temp = getSuspendedCache(), JSCompiler_object_inline_message_2470 = {
            baseLanes: JSCompiler_object_inline_message_2470.baseLanes | renderLanes,
            cachePool: JSCompiler_temp
        }), JSCompiler_object_inline_componentStack_2473.memoizedState = JSCompiler_object_inline_message_2470, JSCompiler_object_inline_componentStack_2473.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_digest_2471, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2472;
        pushPrimaryTreeSuspenseHandler(workInProgress);
        ...
        null !== current && (JSCompiler_object_inline_digest_2471 = workInProgress.deletions, null === JSCompiler_object_inline_digest_2471 ? (workInProgress.deletions = [
            current
        ], workInProgress.flags |= 16) : JSCompiler_object_inline_digest_2471.push(current));
    ...
    function flushPendingEffects(wasDelayedCommit) {
        ...
        if (pendingEffectsStatus === PENDING_GESTURE_ANIMATION_PHASE) {
            ...
            try {
                var rootContainer = root.containerInfo;
                var containerInstance = 9 === rootContainer.nodeType ? rootContainer.body : "HTML" === rootContainer.nodeName ? rootContainer.ownerDocument.body : rootContainer;
                "root" === containerInstance.style.viewTransitionName && (containerInstance.style.viewTransitionName = "");
    ...
    var CapturedStacks = new WeakMap(), OffscreenVisible = 1, OffscreenDetached = 2, OffscreenPassiveEffectsConnected = 4, concurrentQueues = [], concurrentQueuesIndex = 0, concurrentlyUpdatedLanes = 0, emptyContextObject = {};
...
//# sourceMappingURL=node_modules_next_dist_965191eb._.js.map